...
if __name__ == '__main__':
    ...
    #model_path = "./model_data/trained_weights_final.h5"     # keras yolov3 h5 model file
    config_path = 'yolov3-tiny.cfg'                   # .cfg  file path
    weight_file = open('yolov3-tiny.weights', 'wb')   # save darknet yolov3 weights file path
